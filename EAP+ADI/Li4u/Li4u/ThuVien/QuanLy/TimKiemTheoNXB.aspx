<%@ Page Language="C#" MasterPageFile="~/MasterPageQL.master" AutoEventWireup="true" CodeFile="TimKiemTheoNXB.aspx.cs" Inherits="ThuVien_QuanLy_TimKiemTheoNXB" Title="Untitled Page" %>
        ...
        <asp:TemplateField HeaderText="Ảnh Bìa">
            <EditItemTemplate>
                <asp:TextBox ID="TextBox1" runat="server" Text='<%# Eval("AnhBia") %>' 
                    Tooltip='<%#"~/ThuVien/QuanLy/ChiTietSach.aspx?MaSach="+Eval("MaSach") %>'></asp:TextBox>
            </EditItemTemplate>
            <ItemTemplate>
                ...
                <br />
                <br />
                <asp:Label ID="lbmasach" runat="server" Text='<%# Eval("MaSach") %>' 
                    style="font-size: small; color: #FF0000"></asp:Label>
                <br />
            </ItemTemplate>
        </asp:TemplateField>
