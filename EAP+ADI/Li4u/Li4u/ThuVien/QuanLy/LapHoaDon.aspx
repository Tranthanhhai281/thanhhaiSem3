<%@ Page Language="C#" MasterPageFile="~/MasterPageQL.master" AutoEventWireup="true" CodeFile="LapHoaDon.aspx.cs" Inherits="ThuVien_QuanLy_LapLuotMuon" Title="Untitled Page" %>
    ...
    <table cellpadding="0" cellspacing="0" style=" width:750px" >
        <tr>
            ...
            <div style="text-align: center">
                <asp:Label ID="lbTitle" runat="server" Text="Lập Hóa Đơn" 
                 ...
                 <asp:GridView ID="grvthongtin" runat="server" CellPadding="4" 
                     ...
                     <Columns>
                         ...
                         <asp:HyperLinkField DataNavigateUrlFields="MaLuotMuon" 
                             DataNavigateUrlFormatString="~/ThuVien/QuanLy/LapChiTietHoaDon.aspx?MaLuotMuon={0}&amp;duongdan=LapHoaDon.aspx" 
                             HeaderText="Hóa Đơn" Text="Lập Hóa Đơn" />
                     </Columns>
