<%@ Page Language="C#" MasterPageFile="~/MasterPageQL.master" AutoEventWireup="true" CodeFile="SachTrietHoc.aspx.cs" Inherits="ThuVien_DocGia_SachTinHoc" Title="SachTrietHoc" %>
...
<asp:Content ID="Content2" runat="server" contentplaceholderid="Main">
    ...
    <div style="background-color: #00CC66"><asp:Label ID="lbTieuDe" runat="server" Text="Sách Triết Học"></asp:Label></div>
    ...
    <ItemTemplate>    
     ...
     <asp:ImageButton ID="ImageButton1" runat="server" Height="100px" 
         ImageUrl='<%# Anh_Bia(Eval("AnhBia")) %>'  Width="80px" 
            PostBackUrl='<%# "~/ThuVien/QuanLy/ChiTietSach.aspx?MaSach="+Eval("MaSach")+"&Duongdan= SachTrietHoc.aspx" %>' />
        ...
        <asp:HyperLink ID="hplnkTenSach" runat="server" 
            NavigateUrl='<%# "~/ThuVien/QuanLy/ChiTietSach.aspx?MaSach="+Eval("MaSach")+"&Duongdan= SachTrietHoc.aspx"%>' 
