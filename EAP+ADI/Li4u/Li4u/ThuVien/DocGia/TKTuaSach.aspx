<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="TKTuaSach.aspx.cs" Inherits="ThuVien_DocGia_TKTuaSach" Title="Untitled Page" %>
                        ...
                        <asp:TemplateField HeaderText="Tên Sách">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="False" 
                                    NavigateUrl='<%# "~/ThuVien/DocGia/ChiTietSach.aspx?MaSach="+Eval("MaSach") %>' 
