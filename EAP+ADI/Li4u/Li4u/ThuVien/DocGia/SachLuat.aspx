<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SachLuat.aspx.cs" Inherits="ThuVien_DocGia_SachTinHoc" Title="Untitled Page" %>
...
<asp:Content ID="Content2" runat="server" contentplaceholderid="Main">
    ...
    <div style="background-color: #00CC66"><asp:Label ID="lbTieuDe" runat="server" Text="Sách Luật"></asp:Label></div>
    ...
    <ItemTemplate>    
     ...
     <asp:ImageButton ID="ImageButton1" runat="server" Height="100px" 
         ImageUrl='<%# Anh_Bia(Eval("AnhBia")) %>'  Width="80px" 
            PostBackUrl='<%# "~/ThuVien/DocGia/ChiTietSach.aspx?MaSach="+Eval("MaSach")+"&Duongdan=SachLuat.aspx" %>' />
        ...
        <asp:HyperLink ID="hplnkTenSach" runat="server" 
            NavigateUrl='<%# "~/ThuVien/DocGia/ChiTietSach.aspx?MaSach="+Eval("MaSach")+"&Duongdan=SachLuat.aspx" %>' 
