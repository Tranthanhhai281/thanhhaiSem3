#pragma checksum "D:\Hoc Lap Trinh\SEM3\thanhhaiSem3\WeatherApp\WeatherApp\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "DE97CC5BFE5274DF55C5109EB8A84D6D"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace WeatherApp
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj4_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::WeatherApp.Models.DailyForecast dataRoot;
            ...
            {
                if (lineNumber == 113 && columnNumber == 36)
                {
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::WeatherApp.Models.DailyForecast) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::WeatherApp.Models.DailyForecast)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::WeatherApp.Models.DailyForecast obj, int phase)
            {
                if (obj != null)
                {
            ...
            private void Update_Day(global::WeatherApp.Models.Day obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_Temperature(global::WeatherApp.Models.Temperature1 obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_Temperature_Maxium(obj.Maxium, phase);
                        this.Update_Temperature_Minium(obj.Minium, phase);
                    }
                }
            }
            private void Update_Temperature_Maxium(global::WeatherApp.Models.Maxium obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_Temperature_Maxium_Value(obj.Value, phase);
                    }
                }
            }
            private void Update_Temperature_Maxium_Value(global::System.Double obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void Update_Temperature_Minium(global::WeatherApp.Models.Minium obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_Temperature_Minium_Value(obj.Value, phase);
                    }
                }
            }
            private void Update_Temperature_Minium_Value(global::System.Double obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
        ...
        private class MainPage_obj11_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::WeatherApp.Models.WeatherJSON dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            private bool removedDataContextHandler = false;
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::WeatherApp.Models.WeatherJSON) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::WeatherApp.Models.WeatherJSON)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::WeatherApp.Models.WeatherJSON obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_Temperature(global::WeatherApp.Models.Temperature obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
        ...
        private class MainPage_obj1_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::WeatherApp.MainPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                if (lineNumber == 104 && columnNumber == 19)
                {
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::WeatherApp.MainPage)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::WeatherApp.MainPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_WeatherEachDays(global::System.Collections.ObjectModel.ObservableCollection<global::WeatherApp.Models.DailyForecast> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void Update_WeatherEachHours(global::System.Collections.ObjectModel.ObservableCollection<global::WeatherApp.Models.WeatherJSON> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
