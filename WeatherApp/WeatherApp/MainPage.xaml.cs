    ...
    public sealed partial class MainPage : Page
    {
        ...
        private async void InitEachDaysJSON()
        {
            ...
            obj.DailyForecasts.ForEach(it =>
            {
                ...
                it.Day.Icon = string.Format("http://vortex.accuweather.com/adc2010/images/slate/icons/{0}.svg" +
                    it.Day.Icon);
                Debug.WriteLine("Binh: " + it.Date);
                WeatherEachDays.Add(it);
            });
            Today.Text = WeatherEachDays[0].Date + "Today";
            MaxTemperature.Text = WeatherEachDays[0].Temperature.Maxium.Value + "";
            MinTemperature.Text = WeatherEachDays[0].Temperature.Minium.Value + "";
